(function() {
    ...
    var Mixins = {
        ...
        bindBackend: function(new_channel) {
            var self = this;
    ...
    Backbone.Collection = (function(Parent) {
        ...
        var Child = function() {
            if (this.backend) {
                if (this.backend.manual_build === true) {
                    this.backend.build = buildBackend;
                } else {
    ...
    function buildBackend(collection) {
        ...
        var set_connected_callback = function(backend) {
        ...
        var backend = {
            name: name,
            channel: channel,
            ready: function(callback, channel) {
                if (channel != this.channel && typeof channel != "undefined") {
                    ...
                    set_connected_callback(backend);
